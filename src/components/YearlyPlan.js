...
const YearlyPlan = () => {
  return (
    <div className="mt-10 flex justify-between items-center">
      <div className="h-[560px] w-[460px] rounded-lg hover:scale-105 bg-gradient-to-b from-[#00A953] to-[#012619] transition-all cursor-pointer bg-white flex flex-col ">
      ...
      <div className="h-[560px] w-[460px] rounded-lg hover:scale-105 bg-gradient-to-b from-[#00A953] to-[#012619] transition-all cursor-pointer bg-white flex flex-col px-10 py-4">
        <div className="planName">
          <h1 className="text-[#9ffdd1] name text-[20px]">Professional</h1>
        </div>
        <div className="price flex flex-col gap-1">
          <h1 className="text-[50px] text-white bigText tracking-wide">
            <span className="line-through text-[17px]">9600 </span>₹8000/
            <span className="text-[17px]">year</span>
          </h1>
          <h1 className="text-white name tracking-wide">(You save 16%)</h1>
        </div>
        <div className="lists mt-7 flex flex-col gap-3">
          <div className="list1 flex gap-5">
            <img src="../images/Available.svg" alt="available" />
        ...
        <div className="button w-full flex justify-center items-center h-full mt-8">
      ...
      <div className="h-[560px] w-[460px] rounded-lg hover:scale-105 bg-gradient-to-b from-[#00A953] to-[#012619] transition-all cursor-pointer bg-white flex flex-col px-10 py-4">
        ...
        <div className="price flex flex-col gap-1">
          <h1 className="text-[50px] text-white bigText tracking-wide">
            <span className="line-through text-[17px]">18000 </span>₹15000/
            <span className="text-[17px]">year</span>
          </h1>
          <h1 className="text-white name tracking-wide">(You save 16%)</h1>
        </div>
        ...
        <div className="button w-full flex justify-center items-center h-full mt-6">
          <button className="bg-[#007711] ring-2 ring-green-800 hover:bg-[#0e5e1a] text-white font-bold py-3 px-10 rounded-lg text-[17px] desc tracking-wider">
            <CashFreeBtn />
          </button>
        </div>
