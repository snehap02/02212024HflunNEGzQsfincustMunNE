...
import AddMediaImage from "../../components/AddMediaImage.js"
import AddMediaVideo from "../../components/AddMediaVideo.js";
  ...
  return (
    <div className="flex flex-col justify-center items-center w-full sm:px-10 md:px-20 2xl:px-72">
      <div className="border border-[#253428] w-full h-[75vh] mt-10 rounded-lg overflow-x-auto scrollbar flex flex-col p-5 xl:px-16 gap-10 lg:gap-14 ">
        ...
        <h2 className="text-[14px] lg:text-[16px] editTitle text-[#359846] text-justify -mt-8 lg:-mt-14">
          Display your work for buyers to explore!
        </h2>
        <div>
        <AddMediaImage/>
        <AddMediaVideo/>
        ...
        {/* Next Button */}
        <div className="nextButton flex justify-end gap-6 items-end w-full -mt-10">
